...
export default function  Home<NextPage>() {
  ...
  return (
      <div>
          ...
          <Row>
              <Col md={4} xs={12}>
                  <a href="https://web3-camp.github.io/ETH-Wallet-Generator/" target="_blank">
                  <CardBox body>
              ...
              <Col md={4} xs={12}>
                  <a href="https://web3-camp.github.io/Polkadot-Wallet-Generator/" target="_blank">
                      <CardBox body>
                          <div className="firstTR">
              ...
              <Col md={4} xs={12}>
                  <a href="https://web3-camp.github.io/batch-sender/index.html" target="_blank">
                      <CardBox body>
                          <div className="firstTR">
